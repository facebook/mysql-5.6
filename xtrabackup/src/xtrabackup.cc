...
static void sigcont_handler(int sig MY_ATTRIBUTE((unused)))
{
...
/*========================*/
	...
	const char*	id,	/*!< in: identifier to convert */
	ulint		idlen,	/*!< in: length of id, in bytes */
	void*		thd MY_ATTRIBUTE((unused)), 
						/*!< in: MySQL connection thread, or NULL */
	ibool		file_id MY_ATTRIBUTE((unused)))
...
/*=======================*/
	...
	ulint		flags MY_ATTRIBUTE((unused)),/*!<in: tablespace
					flags */
...
xtrabackup_apply_delta(
	...
	my_bool check_newer MY_ATTRIBUTE((unused)))
{
	os_file_t	src_file = XB_FILE_UNDEFINED;
