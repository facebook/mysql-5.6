...
static void test_noop() {
  ...
  psi_statement_service->inc_statement_rows_deleted(nullptr, 0);
  psi_statement_service->inc_statement_rows_inserted(nullptr, 0);
  psi_statement_service->inc_statement_rows_updated(nullptr, 0);
