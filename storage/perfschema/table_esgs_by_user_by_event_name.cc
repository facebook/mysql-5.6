...
int table_esgs_by_user_by_event_name::delete_all_rows(void) {
...
ha_rows table_esgs_by_user_by_event_name::get_row_count(void) {
...
int table_esgs_by_user_by_event_name::index_next(void) {
  PFS_user *user;
  PFS_stage_class *stage_class;
  bool has_more_user = true;
