...
Plugin_table table_esgs_by_account_by_event_name::m_table_def(
    /* Schema name */
    "performance_schema",
    /* Name */
...
bool PFS_index_esgs_by_account_by_event_name::match(
...
PFS_engine_table *table_esgs_by_account_by_event_name::create(
    PFS_engine_table_share *) {
  return new table_esgs_by_account_by_event_name();
}

int table_esgs_by_account_by_event_name::delete_all_rows(void) {
  reset_events_stages_by_thread();
  reset_events_stages_by_account();
  return 0;
}

ha_rows table_esgs_by_account_by_event_name::get_row_count(void) {
...
int table_esgs_by_account_by_event_name::rnd_init(bool) { return 0; }
...
int table_esgs_by_account_by_event_name::make_row(PFS_account *account,
...
int table_esgs_by_account_by_event_name::read_row_values(TABLE *table,
                                                         unsigned char *buf,
                                                         Field **fields,
                                                         bool read_all) {
  Field *f;
