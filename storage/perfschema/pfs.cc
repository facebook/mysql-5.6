...
void pfs_unbind_table_v1(PSI_table *table) {
  ...
  if (likely(pfs != nullptr)) {
    if (pfs->m_has_queries_happened && pfs->m_thread_owner != nullptr) {
...
#define SET_MAX_STATEMENT_ATTR_BODY(LOCKER, ATTR, VALUE) \
  STATEMENT_ATTR_BODY_PROLOG(LOCKER)                     \
  if (state->current_state.m_##ATTR >= (VALUE)) {                          \
    return;                                              \
  }                                                      \
  STATEMENT_ATTR_BODY_OP(LOCKER, ATTR, VALUE, =)
...
void pfs_end_statement_v2(PSI_statement_locker *locker, void *stmt_da) {
  ...
  if (flags & STATE_FLAG_TIMED) {
    ...
    state->current_state.m_elapsed_time = normalizer->wait_to_pico(wait_time);
  }
  ...
  */
  ...
  stat->m_cpu_time += state->current_state.m_cpu_time;
  ...
  stat->m_tmp_table_bytes_written += state->current_state.m_tmp_table_bytes_written;
  stat->m_filesort_bytes_written += state->current_state.m_filesort_bytes_written;
  ...
  stat->m_created_tmp_disk_tables += state->current_state.m_created_tmp_disk_tables;
  ...
  stat->m_select_full_range_join += state->current_state.m_select_full_range_join;
  ...
  stat->m_filesort_disk_usage_peak += state->current_state.m_filesort_disk_usage_peak;
  stat->m_tmp_table_disk_usage_peak += state->current_state.m_tmp_table_disk_usage_peak;
  ...
  if (digest_stat != nullptr) {
    ...
    digest_stat->m_stat.m_cpu_time += state->current_state.m_cpu_time;
    ...
    digest_stat->m_stat.m_index_dive_count += state->current_state.m_index_dive_count;
    digest_stat->m_stat.m_index_dive_cpu += state->current_state.m_index_dive_cpu;
    digest_stat->m_stat.m_compilation_cpu += state->current_state.m_compilation_cpu;
    ...
    digest_stat->m_stat.m_created_tmp_tables += state->current_state.m_created_tmp_tables;
    digest_stat->m_stat.m_select_full_join += state->current_state.m_select_full_join;
    ...
    digest_stat->m_stat.m_select_range_check += state->current_state.m_select_range_check;
    digest_stat->m_stat.m_select_scan += state->current_state.m_select_scan;
    digest_stat->m_stat.m_sort_merge_passes += state->current_state.m_sort_merge_passes;
    ...
    digest_stat->m_stat.m_no_good_index_used += state->current_state.m_no_good_index_used;
  ...
  if (pfs_program != nullptr) {
    ...
    if (sub_stmt_stat != nullptr) {
      ...
      sub_stmt_stat->m_cpu_time += state->current_state.m_cpu_time;
      ...
      sub_stmt_stat->m_filesort_bytes_written +=
          state->current_state.m_filesort_bytes_written;
      sub_stmt_stat->m_index_dive_count += state->current_state.m_index_dive_count;
      sub_stmt_stat->m_index_dive_cpu += state->current_state.m_index_dive_cpu;
      sub_stmt_stat->m_compilation_cpu += state->current_state.m_compilation_cpu;
      sub_stmt_stat->m_elapsed_time += state->current_state.m_elapsed_time;
      sub_stmt_stat->m_created_tmp_disk_tables +=
          state->current_state.m_created_tmp_disk_tables;
      sub_stmt_stat->m_created_tmp_tables += state->current_state.m_created_tmp_tables;
      sub_stmt_stat->m_select_full_join += state->current_state.m_select_full_join;
      sub_stmt_stat->m_select_full_range_join +=
          state->current_state.m_select_full_range_join;
      sub_stmt_stat->m_select_range += state->current_state.m_select_range;
      sub_stmt_stat->m_select_range_check += state->current_state.m_select_range_check;
      sub_stmt_stat->m_select_scan += state->current_state.m_select_scan;
      sub_stmt_stat->m_sort_merge_passes += state->current_state.m_sort_merge_passes;
      ...
      sub_stmt_stat->m_no_good_index_used += state->current_state.m_no_good_index_used;
  ...
  if (pfs_prepared_stmt != nullptr) {
    if (state->m_in_prepare) {
      ...
      if (prepared_stmt_stat != nullptr) {
        ...
        prepared_stmt_stat->m_cpu_time += state->current_state.m_cpu_time;
        prepared_stmt_stat->m_rows_sent += state->current_state.m_rows_sent;
        prepared_stmt_stat->m_rows_examined += state->current_state.m_rows_examined;
        prepared_stmt_stat->m_rows_deleted += state->current_state.m_rows_deleted;
        prepared_stmt_stat->m_rows_inserted += state->current_state.m_rows_inserted;
        prepared_stmt_stat->m_rows_updated += state->current_state.m_rows_updated;
        prepared_stmt_stat->m_tmp_table_bytes_written +=
            state->current_state.m_tmp_table_bytes_written;
        prepared_stmt_stat->m_filesort_bytes_written +=
            state->current_state.m_filesort_bytes_written;
        prepared_stmt_stat->m_index_dive_count += state->current_state.m_index_dive_count;
        prepared_stmt_stat->m_index_dive_cpu += state->current_state.m_index_dive_cpu;
        prepared_stmt_stat->m_compilation_cpu += state->current_state.m_compilation_cpu;
        prepared_stmt_stat->m_elapsed_time += state->current_state.m_elapsed_time;
        prepared_stmt_stat->m_created_tmp_disk_tables +=
            state->current_state.m_created_tmp_disk_tables;
        prepared_stmt_stat->m_created_tmp_tables += state->current_state.m_created_tmp_tables;
        prepared_stmt_stat->m_select_full_join += state->current_state.m_select_full_join;
        prepared_stmt_stat->m_select_full_range_join +=
            state->current_state.m_select_full_range_join;
        prepared_stmt_stat->m_select_range += state->current_state.m_select_range;
        prepared_stmt_stat->m_select_range_check += state->current_state.m_select_range_check;
        prepared_stmt_stat->m_select_scan += state->current_state.m_select_scan;
        prepared_stmt_stat->m_sort_merge_passes += state->current_state.m_sort_merge_passes;
        ...
        prepared_stmt_stat->m_no_index_used += state->current_state.m_no_index_used;
        prepared_stmt_stat->m_no_good_index_used += state->current_state.m_no_good_index_used;
