...
void pfs_inc_statement_rows_deleted_vc(PSI_statement_locker *locker,
                                       ulonglong count) {
  INC_STATEMENT_ATTR_BODY(locker, rows_deleted, count);
}

void pfs_inc_statement_rows_inserted_vc(PSI_statement_locker *locker,
                                        ulonglong count) {
  INC_STATEMENT_ATTR_BODY(locker, rows_inserted, count);
}

void pfs_inc_statement_rows_updated_vc(PSI_statement_locker *locker,
                                       ulonglong count) {
...
void pfs_snapshot_statement_vc(PSI_statement_locker *locker, void * /**/) {
  PSI_statement_locker_state *state =
      reinterpret_cast<PSI_statement_locker_state *>(locker);
...
PSI_statement_service_v4 pfs_statement_service_v4 = {
    ...
    pfs_update_statement_filesort_disk_usage_vc,
    pfs_update_statement_tmp_table_disk_usage_vc,
