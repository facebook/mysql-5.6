...
#define os_thread_create(f,n,a,i)	\
	os_thread_create_func(reinterpret_cast<os_thread_func_t>(f), n, a, i)
...
#define os_thread_create(f,n,a,i)	os_thread_create_func(f, n, a, i)
