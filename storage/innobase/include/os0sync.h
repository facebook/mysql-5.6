...
#define SIGNAL_COUNT(var) (static_cast<ib_int64_t>((var)->stats & I64_MAX))
#define SET_IS_SET(var) { (var)->stats |= I64_MIN; }
#define CLEAR_IS_SET(var) { (var)->stats &= I64_MAX; }
#define IS_SET(var) (((var)->stats & I64_MIN) != 0)
