...
void trx_lra_reset(
    ...
    ulint lra_size, /*!< in: lra_size in MB. If 0, the fields that are related
                    to logical-read-ahead will be free'd if they were
                    initialized. */
    ulint lra_pages_before_sleep, /*!< in: lra_pages_before_sleep is the number
                                  of node pointer records traversed while
                                  holding the index lock before releasing the
