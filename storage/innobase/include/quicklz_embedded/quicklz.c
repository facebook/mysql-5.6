...
#include "quicklz_embedded/quicklz.h"
...
size_t qlz_compress(const void *source, char *destination, size_t size, void* state_)
{
	size_t r;
	ui32 compressed;
	size_t base;
	qlz_state_compress* state = (qlz_state_compress*)state_;
...
size_t qlz_decompress(const char *source, void *destination, void *state_)
{
	qlz_state_decompress* state = (qlz_state_decompress*)state_;
