...
# endif /* __WIN__ */
	...
	for (i = 0; i < srv_n_file_io_threads; ++i) {
		...
		os_thread_t io_handler_handle = os_thread_create(io_handler_thread, n + i, thread_ids + i);
...
files_checked:
	...
	if (!srv_read_only_mode) {
		...
		for lock waits */
		os_thread_t lock_wait_timeout_handle =
      os_thread_create(
    ...
    pthread_setname_np(lock_wait_timeout_handle, "innodb-lockwait");
		...
		os_thread_t srv_error_monitor_handle =
      os_thread_create(
    ...
    pthread_setname_np(srv_error_monitor_handle, "innodb-errmontr");
		...
		os_thread_t srv_monitor_handle =
      os_thread_create(
        srv_monitor_thread,
    ...
    os_thread_t srv_purge_coordinator_handle =
      os_thread_create(
        srv_purge_coordinator_thread,
        NULL, thread_ids + 5 + SRV_MAX_N_IO_THREADS);
    pthread_setname_np(srv_purge_coordinator_handle, "innodb-prgcoord");
	...
	if (!srv_read_only_mode) {
    os_thread_t buf_flush_page_cleaner_handle =
		  os_thread_create(buf_flush_page_cleaner_thread, NULL, NULL);
    pthread_setname_np(buf_flush_page_cleaner_handle, "innodb-pgcleanr");
	}

  os_thread_t buf_flush_lru_manager_handle =
