...
class Rdb_transaction : private rocksdb::TransactionNotifier
{
...
public:
  ...
  // Override of TransactionNotifier:SnapshotCreated
  ...
  void acquire_snapshot(bool lock_rows = false)
  {
    if (read_opts.snapshot == nullptr && !is_delayed_snapshot) {
      txn->SetSnapshotOnNextOperation(this);
  ...
  */
  void start_stmt(bool lock_rows)
  {
    acquire_snapshot(lock_rows);
    txn->SetSavePoint();
  }
