...
struct ha_rocksdb_inplace_ctx : public inplace_alter_handler_ctx
{
  ...
  ha_rocksdb_inplace_ctx(
      RDBSE_TABLE_DEF* new_tdef_, RDBSE_KEYDEF** old_key_descr_,
      RDBSE_KEYDEF** new_key_descr_, uint old_n_keys_, uint new_n_keys_,
                                 ...
                                 Alter_inplace_info *ha_alter_info)
{
  ...
  if (ha_alter_info->handler_flags &
     ...
     && prepare_drop_index_inplace(altered_table, ha_alter_info, new_tdef,
          old_key_descr, new_key_descr, old_n_keys, &dropped_index_ids))
  {
    DBUG_RETURN(1);
  }
...
bool ha_rocksdb::prepare_drop_index_inplace(
    ...
    RDBSE_KEYDEF** new_key_descr, uint old_n_keys,
    std::unordered_set<GL_INDEX_ID>* dropped_index_ids)
{
