...
static int rocksdb_shutdown(bool minimalShutdown) {
  ...
  // The only code executed during both normal and init faiure shutdown are deleting mutexes.
  // The plan is to gradually increase this section so there's one single shutdown function for
  // all scenarios.
