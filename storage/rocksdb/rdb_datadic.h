...
class Rdb_key_field_iterator {
 ...
 public:
  ...
  Rdb_key_field_iterator(const Rdb_key_def *key_def,
                         ...
                         Rdb_string_reader &reader,
                         Rdb_string_reader &unp_reader, const TABLE &table,
...
class Rdb_key_def {
  ...
  */
  ...
  [[nodiscard]] static int unpack_unsigned(const Rdb_field_packing &fpi,
                                           Rdb_unpack_func_context *, uchar *to,
                                           Rdb_string_reader &reader,
                                           Rdb_string_reader *);
  ...
  [[nodiscard]] static int unpack_binary_varlength(const Rdb_field_packing &fpi,
                                                   Rdb_unpack_func_context *ctx,
                                                   uchar *dst,
                                                   Rdb_string_reader &reader,
                                                   Rdb_string_reader *);
  ...
  [[nodiscard]] static int unpack_binary_or_utf8_varlength_space_pad(
      const Rdb_field_packing &fpi, Rdb_unpack_func_context *ctx, uchar *dst,
  ...
  [[nodiscard]] static int unpack_unknown(const Rdb_field_packing &fpi,
                                          Rdb_unpack_func_context *, uchar *dst,
                                          Rdb_string_reader &reader,
                                          Rdb_string_reader *unp_reader);
  ...
  */
  ...
  /*
    ...
    Currently this support varchar and blob data types.
  */
  [[nodiscard]] static uchar *get_data_start_ptr(const Rdb_field_packing &fpi,
                                                 uchar *dst,
                                                 Rdb_unpack_func_context *ctx);
