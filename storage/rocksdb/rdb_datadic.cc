...
uchar* str_to_uchar_ptr(String * str)
{
                                   ...
                                   key_part_map keypart_map)
{
  ...
  key_restore(tbl->record[0], key_tuple,
              &tbl->key_info[m_keyno],
              key_len);
                              ...
                              longlong hidden_pk_id)
{
  ...
  for (uint i=0; i < n_key_parts; i++)
  {
    ...
    DBUG_ASSERT((static_cast<int>(max_storage_fmt_length())
                 - (tuple - packed_tuple)) >=
                 static_cast<int>(m_pack_info[i].max_image_len));
                                 ...
                                 uchar *packed_tuple) const
{
  ...
  DBUG_ASSERT(
      (static_cast<int>(max_storage_fmt_length())-(tuple - packed_tuple)) >=
       static_cast<int>(m_pack_info[0].max_image_len));
