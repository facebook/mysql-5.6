...
uint Rdb_key_def::pack_index_tuple(bool should_store_checksums, TABLE *tbl,
                                   ...
                                   key_part_map keypart_map) const
{
  ...
  return pack_record(should_store_checksums, tbl, pack_buffer,
                     tbl->record[0], packed_tuple, nullptr, nullptr,
                     n_used_parts);
}
...
uint Rdb_key_def::pack_record(bool should_store_checksums, TABLE *tbl,
                              uchar *pack_buffer,
                              const uchar *record,
                              uchar *packed_tuple,
...
int Rdb_key_def::unpack_record(bool verify_checksums, TABLE *table,
