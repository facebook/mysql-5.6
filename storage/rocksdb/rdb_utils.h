...
/*
  Define a readability token so that we can do calls like my_core::thd_ha_data()
  rather than plain thd_ha_data(). This technique adds an immediate visible cue
  on what type of API we are calling into.
*/
