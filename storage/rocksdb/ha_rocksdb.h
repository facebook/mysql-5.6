...
struct ha_rocksdb_inplace_ctx : public inplace_alter_handler_ctx
{
  ...
  ha_rocksdb_inplace_ctx(
      Rdb_tbl_def* new_tdef_, std::shared_ptr<Rdb_key_def>* old_key_descr_,
      std::shared_ptr<Rdb_key_def>* new_key_descr_, uint old_n_keys_,
      uint new_n_keys_, std::unordered_set<GL_INDEX_ID> dropped_index_ids_,
