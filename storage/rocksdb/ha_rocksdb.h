...
/**
  @brief
  Rdb_table_handler is a structure storing information for each open table.
  All the instances are stored in a global hash map (@seealso Rdb_open_tables
  class).
...
public:
  ...
  */
  ...
  my_core::Item* idx_cond_push(uint keyno, my_core::Item* idx_cond);
  /*
