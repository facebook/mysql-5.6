...
/*
  ...
  alter calls
*/
struct Rdb_inplace_ctx : public my_core::inplace_alter_handler_ctx
{
  ...
  Rdb_inplace_ctx(
    ...
    my_core::inplace_alter_handler_ctx(), m_new_tdef(new_tdef_),
    m_old_key_descr(old_key_descr_), m_new_key_descr(new_key_descr_),
    m_old_n_keys(old_n_keys_), m_new_n_keys(new_n_keys_),
    m_dropped_index_ids(dropped_index_ids_),
    m_n_dropped_keys(n_dropped_keys_)
  {
  }
 ...
 private:
  /* Disable Copying */
  Rdb_inplace_ctx(const Rdb_inplace_ctx&);
  Rdb_inplace_ctx& operator=(const Rdb_inplace_ctx&);
};
