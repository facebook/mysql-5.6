...
#define HA_ERR_ROCKSDB_TOO_MANY_LOCKS (HA_ERR_ROCKSDB_FIRST + 1)
#define HA_ERR_ROCKSDB_LOCK_WAIT_TIMEOUT (HA_ERR_ROCKSDB_FIRST + 2)
#define HA_ERR_ROCKSDB_TABLE_DATA_DIRECTORY_NOT_SUPPORTED                      \
  (HA_ERR_ROCKSDB_FIRST + 3)
#define HA_ERR_ROCKSDB_TABLE_INDEX_DIRECTORY_NOT_SUPPORTED                     \
  (HA_ERR_ROCKSDB_FIRST + 4)
#define HA_ERR_ROCKSDB_COMMIT_FAILED (HA_ERR_ROCKSDB_FIRST + 5)
#define HA_ERR_ROCKSDB_BULK_LOAD (HA_ERR_ROCKSDB_FIRST + 6)
#define HA_ERR_ROCKSDB_CORRUPT_DATA (HA_ERR_ROCKSDB_FIRST + 7)
#define HA_ERR_ROCKSDB_CHECKSUM_MISMATCH (HA_ERR_ROCKSDB_FIRST + 8)
#define HA_ERR_ROCKSDB_INVALID_TABLE (HA_ERR_ROCKSDB_FIRST + 9)
#define HA_ERR_ROCKSDB_PROPERTIES (HA_ERR_ROCKSDB_FIRST + 10)
#define HA_ERR_ROCKSDB_MERGE_FILE_ERR (HA_ERR_ROCKSDB_FIRST + 11)
#define HA_ERR_ROCKSDB_LAST HA_ERR_ROCKSDB_MERGE_FILE_ERR
