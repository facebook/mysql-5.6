...
def main():
  ...
  DBLWR_FAIL_MESSAGE = "Cannot recover it from the doublewrite buffer because it was written in reduced-doublewrite mode.\n"
  DBLWR_FAIL0_MESSAGE = "Doublewrite does not have page_no=0 of space: "
  DBLWR_SUCCESS_MESSAGE = "Trying to recover it from the doublewrite buffer.\n"
  DBLWR_SUCCESS0_MESSAGE = "Restoring page 0 of tablespace "
  ...
  mysqld_cmd += ' --log_error=%s --log_error_verbosity=3'  % log_file
