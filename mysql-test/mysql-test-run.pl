...
#
my $DEFAULT_SUITES= "main,sys_vars,binlog,federated,grant,rpl,rpl_recovery,rpl_mts,innodb,innodb_fts,innodb_zip,perfschema,funcs_1,opt_trace,parts,auth_sec,connection_control,innodb_stress,json,column_statistics,privacy";
my $opt_suites;
