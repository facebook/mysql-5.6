...
struct TestWithParamUInt64 :
    public TestWithParam, ::testing::TestWithParam<uint64_t>{};
struct TestWithParamInt64 :
    public TestWithParam, ::testing::TestWithParam<int64_t>{};
struct TestWithParamUInt32 :
    public TestWithParam, ::testing::TestWithParam<uint32_t>{};
struct TestWithParamInt32 :
    public TestWithParam, ::testing::TestWithParam<int32_t>{};
struct TestWithParamLen :
    public TestWithParam, ::testing::TestWithParam<size_t>{};
struct TestNoParam :
    public TestWithParam, ::testing::Test {};
...
INSTANTIATE_TEST_CASE_P(TestLimitsUInt64, TestWithParamUInt64,
    ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(TestLimitsUInt32, TestWithParamUInt32,
    ::testing::Values(
        0, 1, 10, 100, 1000, 10000, 100000,
        1000000, 10000000, 100000000, 1000000000,
