...
INSTANTIATE_TEST_SUITE_P(
    TestLimitsInt64, TestWithParamInt64,
    ::testing::Values(0, 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000,
                      100000000, 1000000000, 10000000000, 100000000000,
                      1000000000000, -1, -10, -100, -1000, -10000, -100000,
...
INSTANTIATE_TEST_SUITE_P(
    TestLimitsInt32, TestWithParamInt32,
    ::testing::Values(0, 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000,
                      100000000, 1000000000, -1, -10, -100, -1000, -10000,
                      -100000, -1000000, -10000000, -100000000, -1000000000,
                      std::numeric_limits<int32_t>::min(),
                      std::numeric_limits<int32_t>::max()));

INSTANTIATE_TEST_SUITE_P(TestShortBufLen, TestWithParamLen,
