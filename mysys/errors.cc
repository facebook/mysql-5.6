...
const struct my_glob_errors globerrs[GLOBERRS] = {
    ...
    {"EE_PLACEHOLDER_98", "%s."},
    {"EE_PLACEHOLDER_99", "%s."},
    {"EE_PLACEHOLDER_100", "%s."},
    {"EE_PLACEHOLDER_101", "%s."},
    {"EE_PLACEHOLDER_102", "%s."},
    {"EE_PLACEHOLDER_103", "%s."},
    {"EE_PLACEHOLDER_104", "%s."},
    {"EE_PLACEHOLDER_105", "%s."},
    {"EE_PLACEHOLDER_106", "%s."},
    {"EE_PLACEHOLDER_107", "%s."},
    {"EE_PLACEHOLDER_108", "%s."},
    {"EE_PLACEHOLDER_109", "%s."},
