...
class Transaction {
 public:
  ...
  virtual void SetName(const TransactionName& name) {
    name_ = name;
  }

  virtual TransactionName GetName() {
    return name_;
  }
  ...
  // does this transaction use two phase commit semantics
  bool two_phase_commit_;
