...
/**
 * @brief Lineage node represents SELECT_LEX_UNIT union unit
 */
class Union_column_lineage_info : public Column_lineage_info {
 public:
  Union_column_lineage_info(uint32_t id, SELECT_LEX_UNIT *unit,
                            MEM_ROOT *mem_root)
...
/**
 * @brief Lineage node represents SELECT_LEX query block
 */
class Query_block_column_lineage_info : public Column_lineage_info {
 public:
  Query_block_column_lineage_info(uint32_t id, SELECT_LEX *query_block,
                                  MEM_ROOT *mem_root)
