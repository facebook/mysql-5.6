...
class THD : public MDL_context_owner,
 ...
 public:
  ...
  /**
   * Returns true if any of the locked tables are TTL enabled
   */
  bool is_any_locked_table_ttl_enabled() const;
  ...
  */
  ...
  explicit THD(bool enable_plugins = true, bool is_slave = false);
  ...
  */
  ...
  /**
      ...
      @param ctx_in_use           The MDL context owner (thread) to wake up.
     */
  bool kill_shared_lock(MDL_context_owner *in_use) override;
