...
class DB_AC {
  ...
  /* Protects db_ac_map and also the current admission control
   * variables i.e; max_running_queries and max_waiting_queries.
   */
  ...
  void init(st_db_ac_info *db_ac_info) {
    ...
    db_ac_info->abort_waiting= false;
