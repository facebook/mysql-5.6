...
#define SETMSG(nr, msg) handler_errmsgs[(nr) - HA_ERR_FIRST]= (msg)
  ...
  SETMSG(HA_ERR_REC_LOCK_WAIT_TIMEOUT,  ER_DEFAULT(ER_LOCK_WAIT_TIMEOUT));
...
void handler::print_error(int error, myf errflag)
{
  ...
  case HA_ERR_REC_LOCK_WAIT_TIMEOUT:
    my_error(ER_LOCK_WAIT_TIMEOUT, errflag, "record");
    DBUG_VOID_RETURN;
    break;
  case HA_ERR_LOCK_WAIT_TIMEOUT:
    my_error(ER_LOCK_WAIT_TIMEOUT, errflag, "table");
    DBUG_VOID_RETURN;
    break;
