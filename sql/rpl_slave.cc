...
static int queue_event(Master_info* mi,const char* buf, ulong event_len)
{
  ...
  /*
    ...
    got accidentally set to be a wrong value somehow. In other words, we need
    this variable to make sure the timestamp of each event in the binlog network
    stream can be updated correctly when the master's timestamp is set wrong
    before writing these events into the relay log.
  */
  ...
  */
  ...
  /*
    ...
    the wrongly set timestamp of the events from the master when necessary.
  ...
  if (cur_event_timestamp != 0)
  {
    ...
    */
    ...
    /*
      ...
      case 1: beyond the current time. case 2: below the last good timestamp,
