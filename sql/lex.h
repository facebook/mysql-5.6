...
static SYMBOL symbols[] = {
  ...
  { "AT",		SYM(AT_SYM)},
  { "ATTACH",		SYM(ATTACH_SYM)},
  { "AUTO_INCREMENT",	SYM(AUTO_INC)},
  { "AUTOEXTEND_SIZE",	SYM(AUTOEXTEND_SIZE_SYM)},
  { "AVG",		SYM(AVG_SYM)},
  { "AVG_ROW_LENGTH",	SYM(AVG_ROW_LENGTH)},
  { "BACKGROUND",    SYM(BACKGROUND_SYM)},
  ...
  { "COMPACT_METADATA",	SYM(COMPACT_METADATA_SYM)},
  { "COMPLETION",	SYM(COMPLETION_SYM)},
  { "COMPRESSED",	SYM(COMPRESSED_SYM)},
  { "COMPRESSION",	SYM(COMPRESSION_SYM)},
  { "COMPRESSION_LEVEL",	SYM(COMPRESSION_LEVEL_SYM)},
  { "CONCURRENT",	SYM(CONCURRENT)},
  { "CONDITION",        SYM(CONDITION_SYM)},
  { "CONNECTION",       SYM(CONNECTION_SYM)},
  { "CONNECTION_ATTRIBUTES", SYM(CONNECTION_ATTRIBUTES_SYM)},
  ...
  { "SRV_SESSIONS",	SYM(SRV_SESSIONS_SYM)},
  { "SQL",              SYM(SQL_SYM)},
  ...
  { "SQL_STATISTICS", SYM(SQL_STATISTICS_SYM)},
  ...
  { "SUPER",		SYM(SUPER_SYM)},
  { "SUPER_READ_ONLY",		SYM(SUPER_READ_ONLY_SYM)},
  ...
  { "TRANSACTION_LIST",	SYM(TRANSACTION_LIST_SYM)},
