...
SHOW_VAR status_vars[] = {
    ...
    {"Bytes_sent", (char *)offsetof(System_status_var, bytes_sent),
     SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
    {"Tmp_table_bytes_written", (char *)offsetof(System_status_var,
     tmp_table_bytes_written), SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
...
PSI_stage_info stage_slave_waiting_semi_sync_ack= { 0, "Waiting for an ACK from semi-sync ACKers", 0, PSI_DOCUMENT_ME};
/* clang-format on */
