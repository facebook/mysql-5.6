...
SHOW_VAR com_status_vars[] = {
    ...
    {"attach_explicit_snapshot",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_ATTACH_EXPLICIT_SNAPSHOT]), 
    ...
    {"create_explicit_snapshot",
     (char *)offsetof(System_status_var, com_stat[(uint) SQLCOM_CREATE_EXPLICIT_SNAPSHOT]),
     SHOW_LONG_STATUS, SHOW_SCOPE_GLOBAL},
    {"create_table",
    ...
    {"release_explicit_snapshot",
     (char *)offsetof(System_status_var, com_stat[(uint)SQLCOM_RELEASE_EXPLICIT_SNAPSHOT]),
     SHOW_LONG_STATUS, SHOW_SCOPE_GLOBAL},
    {"rename_table",
