...
int multi_tenancy_exit_query(THD *thd) {
  ...
  assert(thd->ac_node && thd->ac_node->ac_info);
 ...
 * @retval 1 on failure
 */
int fill_ac_entities(THD *thd, Table_ref *tables, Item *) {
 ...
 * @retval 1 on failure
 */
int fill_ac_errors(THD *thd, Table_ref *tables, Item *) {
