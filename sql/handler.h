...
public:
  ...
  */
  ...
  int ha_defragment_table(const char *name, const char *index, bool async, Alter_info* alter_info);
...
public:
  ...
  */
  ...
  virtual int defragment_table(const char *name, const char *index, bool async, Alter_info* alter_info)
  { return HA_ADMIN_NOT_IMPLEMENTED; }
