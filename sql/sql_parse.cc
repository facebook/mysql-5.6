...
const LEX_STRING command_name[] = {
    ...
    {nullptr, 0},
    {nullptr, 0},
    {C_STRING_WITH_LEN("Error")},  // COM_TOP_BEGIN
    {C_STRING_WITH_LEN(
        "Send Replica Statistics")},  // COM_SEND_REPLICA_STATISTICS
    {C_STRING_WITH_LEN("Error")},  // COM_QUERY_ATTRS
};
