...
class Field_string :public Field_longstr {
 public:
  /*
    This varaible is used when we do padding and should also be removed
    once we can use 0 as the padding for index.
    When true, it's created from an index using old style. Otherwise,
    it's false.
  */
    ...
    switch(doc_type)
    {
      ...
      case DOC_PATH_STRING:
        field= new (root) Field_string(new_ptr,
                                       ...
                                       field_name,
                                       charset());
        ((Field_string*)field)->document_key_field = true;
        break;
      case DOC_PATH_INT:
