...
int Raft_replication_delegate::before_flush(THD *thd, IO_CACHE *io_cache,
  ...
  // TODO: Once we merge with mt ring replication we will start populating this from THD
...
int Raft_replication_delegate::register_paths(
  ...
  FOREACH_OBSERVER_STRICT(
      ret, register_paths,
      (&param, &raft_listener_queue, s_uuid, server_id, wal_dir_parent, log_dir_parent,
