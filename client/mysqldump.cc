...
static bool verbose = 0, opt_no_create_info = 0, opt_no_data = 0, quick = 1,
            ...
            opt_order_by_primary_desc = 0, opt_rocksdb_bulk_load = 0,
            opt_rocksdb_bulk_load_allow_sk = 0,
            opt_innodb_stats_on_metadata = 0, opt_set_minimum_hlc = 0;
...
static char *opt_password = 0, *current_user = 0, *current_host = 0, *path = 0,
            ...
            *opt_dump_fbobj_assoc_stats = NULL, *log_error_file = NULL;
...
static struct my_option my_long_options[] = {
    ...
    {"lra_sleep", OPT_LRA_SLEEP,
     ...
     &opt_lra_sleep, 0, GET_ULONG, REQUIRED_ARG, 0, 0, 1000, 0, 0, 0},
    {"lra_pages_before_sleep", OPT_LRA_PAGES_BEFORE_SLEEP,
     ...
     REQUIRED_ARG, 1024, 128, ULONG_MAX, 0, 0, 0},
...
#include "sslopt-longopts.h"
    ...
    {"thread-priority", OPT_THREAD_PRIORITY,
     ...
     &opt_thread_priority, 0, GET_INT, REQUIRED_ARG, 0, -20, 19, 0, 0, 0},
    {"compress-data", OPT_COMPRESS_DATA,
     "Enables compression of data using ZSTD", &opt_compress_data,
     &opt_compress_data, 0, GET_BOOL, NO_ARG, 0, 0, 0, 0, 0, 0},
    {"compress-data-chunk-size", OPT_COMPRESS_DATA_CHUNK_SIZE,
     ...
     OPT_ARG, 0, 0, (ulonglong)(~(my_off_t)0), 0, 0, 0},
